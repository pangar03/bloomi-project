...
const SettingsPage = () => {
    ...
    return (
        <>
            <div
                className={`${isUnlocked ? "hidden" : ""} pin-unlock-display flex flex-col gap-16 items-center mx-auto justify-center h-full bg-white`}
            >
                <div></div>
                <div className="flex flex-col gap-4 items-center">
                    <h1 className="text-l text-black">Enter your parent pin</h1>
