...
const Register = () => {
    ...
    useEffect(() => {
        if (currentPage !== "register") setCurrentPage("register");
                ...
                {step === "pin" && (
                    <>
                        <div className="w-64 sm:w-72 md:w-96 mx-auto text-center flex flex-col items-center gap-2 px-4 mt-25">
                            <h1 className="w-full text-[24px] sm:text-[28px] md:text-4xl font-bold whitespace-nowrap leading-[30px] sm:leading-[34px]">
                                Create your parent pin
                            </h1>
                            <p className="w-full text-[14px] md:text-base text-gray-500 whitespace-nowrap leading-[20px]">
                                It will help you access{" "}
