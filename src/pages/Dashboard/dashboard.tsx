...
function Dashboard() {
    ...
    return (
        <>
            <div className="lg:w-[60%] lg:rounded-none w-full lg:h-screen h-full overflow-y-scroll mx-auto custom-scrollbar flex flex-col items-center lg:px-16 px-4 py-8 rounded-t-rounded bg-white">
