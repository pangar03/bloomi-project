...
const NavBar = () => {
    return (
        <nav className="flex-col lg:w-[20vw] w-full lg:h-screen h-fit shadow-md justify-start absolute bottom-0 border-gray-light lg:border-t-0 lg:border-r-1 bg-white">
